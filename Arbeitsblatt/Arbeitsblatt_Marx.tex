...
\textbf{Philosophie Q1} \\ Herr Dayi%
\end{minipage}%
\begin{minipage}[b]{0.45\textwidth}%
\centering\textbf{\large Anthropologie \& Kultur (IF 3)}%
\end{minipage}%
\begin{minipage}[b]{0.25\textwidth}%
\raggedleft Datum: \rule{2.5cm}{0.4pt}%
\end{minipage}
...
\raisebox{-0.85\height}{\includegraphics[width=2.1cm]{Marx.png}} 
\end{tabularx}
\end{tcolorbox}
...
% === AUFGABE 3: ARBEIT IM ADVANCED ORGANIZER ===
\begin{aufgabe}{\iconPA \, / \, \iconEA}
\textbf{Arbeit im Advanced Organizer (AO):}
\begin{enumerate}[label=\alph*), leftmargin=0.5cm, itemsep=0.06cm]
    \item \textbf{Ordnet} Karl Marx in euren digitalen \textbf{Advanced Organizer} ein (\texttt{herrdayi.github.io/AO}).
    \item \textbf{Formuliert} seine Kernaussage zur entfremdeten Arbeit in einem prägnanten Satz und verknüpft seine Position mit den Ansätzen von Arnold Gehlen (\glqq Entlastung\grqq) und Sigmund Freud (\glqq Triebverzicht\grqq).
\end{enumerate}
\end{aufgabe}
