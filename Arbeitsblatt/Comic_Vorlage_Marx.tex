...
\begin{minipage}[t]{0.238\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \scriptsize
        \textit{\glqq[\dots] während der Mensch frei produziert [\dots] nach den Gesetzen der Schönheit.\grqq}
        \vspace{4pt}
        {\color{primaryBlue!30}\hrule height 0.6pt}
        
        % Freier Zeichenbereich
        \vspace{6pt}
        \centering
        \begin{tikzpicture}
            % Vorgezeichnete Sprechblase als Impuls
            \draw[gray!50, dashed, rounded corners=3mm, thick] (0, 0) rectangle (4.6, 1.4);
            \node[gray!60, font=\tiny\sffamily] at (2.3, 0.7) {Sprech- oder Denkblase};
        \end{tikzpicture}
...
\begin{minipage}[t]{0.238\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \scriptsize
        \textit{\glqq Was das Produkt seiner Arbeit ist, ist er nicht. [\dots] Herrschaft des Kapitals.\grqq}
        \vspace{4pt}
        {\color{primaryBlue!30}\hrule height 0.6pt}
        ...
        \begin{tikzpicture}
            % Vorgezeichnete Sprechblase als Impuls
            \draw[gray!50, dashed, rounded corners=3mm, thick] (0, 0) rectangle (4.6, 1.4);
            \node[gray!60, font=\tiny\sffamily] at (2.3, 0.7) {Chaplin-Ruf: \glqq Die Maschine \dots!\grqq};
        \end{tikzpicture}
...
\begin{minipage}[t]{0.238\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \scriptsize
        \textit{\glqq In der Arbeit außer sich [\dots] keine freie Energie, sondern Kasteiung der Physis.\grqq}
        \vspace{4pt}
        {\color{primaryBlue!30}\hrule height 0.6pt}
        ...
        \begin{tikzpicture}
            % Vorgezeichnete Sprechblase als Impuls
            \draw[gray!50, dashed, rounded corners=3mm, thick] (0, 0) rectangle (4.6, 1.4);
            \node[gray!60, font=\tiny\sffamily] at (2.3, 0.7) {Gedanke: \glqq Wann ist Feierabend?\grqq};
        \end{tikzpicture}
...
\begin{minipage}[t]{0.238\textwidth}
    ...
    \begin{tcolorbox}[
        ...
        \scriptsize
        \textit{\glqq In seinen tierischen Funktionen freitätig und in menschlichen nur mehr als Tier.\grqq}
        \vspace{4pt}
        {\color{primaryBlue!30}\hrule height 0.6pt}
        ...
        \begin{tikzpicture}
            % Vorgezeichnete Sprechblase als Impuls
            \draw[gray!50, dashed, rounded corners=3mm, thick] (0, 0) rectangle (4.6, 1.4);
            \node[gray!60, font=\tiny\sffamily] at (2.3, 0.7) {\glqq Endlich frei!\grqq{} (Couch / Burger)};
        \end{tikzpicture}
